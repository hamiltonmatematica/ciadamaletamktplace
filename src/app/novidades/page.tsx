...
export default function NovidadesPage() {
    ...
    useEffect(() => {
        async function load() {
            const prods = await getNewestProducts(10);
            setProducts(prods);
            setLoading(false);
        }
        load();
                ...
                <section className="mx-auto max-w-7xl px-6 py-12">
                    <div className="mb-10">
                        <div className="flex items-center gap-3 mb-2">
                            <span className="material-symbols-outlined text-3xl text-primary">new_releases</span>
                            <h1 className="text-4xl font-black tracking-tight">Novidades</h1>
                        </div>
                        <p className="text-slate-500 font-medium">Os 10 últimos produtos adicionados ao nosso catálogo</p>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-20">
                            ...
                            <p className="text-slate-500 font-medium text-lg">Nenhuma novidade no momento</p>
                        </div>
                    ) : (
                        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
